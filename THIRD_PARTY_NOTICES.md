...
Four dog color sets (`brown`, `black`, `red`, `white`) are copied byte-for-byte
...
The horse GIFs are artwork by [Onfe](https://onfe.itch.io/horse-sprite-with-rider-asset-pack),
...
The other 120 bundled GIFs were created for this project using OpenAI's built-in
image generation tool. The 13 original RGBA sheets, exact prompts, variant order,
and reviewed frame bounds are in `Artwork/`. `script/generate_original_sprites.py`
